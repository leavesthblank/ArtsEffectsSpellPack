...
public class TimeDay extends Spell {
    public TimeDay() {
        super(EnumTier.ADVANCED, 60, EnumElement.EARTH, "today", EnumSpellType.UTILITY, 10000, EnumAction.none, false);
    }

    public boolean cast(World world, EntityPlayer entityPlayer, int i, float v, float v1, float v2, float v3) {
        world.setWorldTime((world.getWorldTime() / 24000) * 24000 + 24000);
